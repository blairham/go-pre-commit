...
| Report | `test/integration/parity_report.json`, regenerated by the suite on every run and uploaded by CI as the [`parity-report`](https://github.com/blairham/go-pre-commit/actions/workflows/ci.yml) artifact |

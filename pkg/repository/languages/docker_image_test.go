...
func TestDockerImageLanguage(t *testing.T) {
	t.Run("NewDockerImageLanguage", func(t *testing.T) {
		...
		// Check properties
		if dockerImage.Name != "docker_image" {
			t.Errorf("Expected name 'docker_image', got '%s'", dockerImage.Name)
		}
	...
	t.Run("ComprehensiveCoverage", func(t *testing.T) {
		...
		t.Run("NewDockerImageLanguage_Properties", func(t *testing.T) {
			...
			if dockerImage.GetName() != "docker_image" {
				t.Errorf("Expected GetName() to return 'docker_image', got '%s'", dockerImage.GetName())
			}

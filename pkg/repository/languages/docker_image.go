...
// GetDefaultVersion returns the default Docker image version
// Following Python pre-commit behavior: returns 'system' if Docker is installed, otherwise 'default'
func (d *DockerImageLanguage) GetDefaultVersion() string {

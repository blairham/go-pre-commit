...
func NewSystemLanguage() *SystemLanguage {
	return &SystemLanguage{
		GenericLanguage: NewGenericLanguage(scriptSystemVersion, "", "", ""),
	}
}

// GetDefaultVersion returns the default system version (always 'system')
func (s *SystemLanguage) GetDefaultVersion() string {
